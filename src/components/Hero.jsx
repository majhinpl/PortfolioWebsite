  ...
  return (
    <>
      <div className="flex flex-col md:flex-row h-full container mx-auto">
        <div className="hidden md:block w-[350px] shadow-2xl shadow-slate-400 p-4">
          <img
            src="https://avatars.githubusercontent.com/u/88680286?s=96&v=4"
            alt=""
            className="rounded-full mb-1"
          />
          <div>
            <h1 className="font-bold">Nepal Majhi</h1>
            <div className="mb-1">
              <span>
                Experienced Professional in Protective Coating and Thermal
                Insulation Maintenance Planning | @BFIM, Saudi Arabia.
              </span>
            </div>
            <div className="mb-4">
              <span>Eager to learn new technology and explore new ideas.</span>
            </div>
            <div className="mb-4">
              <span>Grinding noise at startup.</span>
              <div className="flex space-x-2">
                <Link to="https://www.facebook.com/stockslify">
                  <img
                    src="https://scontent.fdmm3-2.fna.fbcdn.net/v/t39.30808-6/435905951_122148470708042149_1934300077555620820_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=5f2048&_nc_ohc=QSyrD0ablcsAb4RZfXb&_nc_ht=scontent.fdmm3-2.fna&oh=00_AfDKXAQbAVQ_eMlgjvX4dWpE6IEDHPw8Mypmd8QLe9jqiw&oe=66218A44"
                    alt="logo of stockslify"
                    width={42}
                    height={42}
                    className="rounded-full border border-green-400 hover:border-green-400"
                  />
                </Link>
                <Link to="https://www.facebook.com/trademajhi">
                  <img
                    src="https://scontent.fdmm3-2.fna.fbcdn.net/v/t39.30808-6/384396456_285746961059472_4504840860249463250_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=5f2048&_nc_ohc=JHyGLhFvvaEAb4aoCTz&_nc_ht=scontent.fdmm3-2.fna&oh=00_AfBc0HlTSIHUIMptAPU9VbH09rPr6NGeSGl6E3_YRLrepg&oe=66219462"
                    alt="logo of trademajhi"
                    width={42}
                    height={42}
                    className="rounded-full border border-green-400 hover:border-green-400"
                  />
          ...
          <div className="mb-4">
            <span className="uppercase">Contact on</span>
            <div>
              <span>+966 572 110 228</span>
            </div>
            <div>
              <span>majhinpl@gmail.com</span>
            </div>
          </div>{" "}
          <div>
            <span className="uppercase">Connect with</span>
            <div className="w-auto">
              <div className="-m-1.5 flex flex-wrap">
                <div className="w-auto p-1.5">
                  <Link to="https://facebook.com/majhinpl">
                ...
                <div className="w-auto p-1.5">
                  <Link to="https://www.instagram.com/trademajhi/">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                      <svg
                        width="16"
                        height="15"
        ...
        <div className="w-70">
          <div className="mx-auto max-w-7xl  lg:gap-x-8 lg:px-8">
            <div className="flex flex-col justify-start py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
              <h2 className="font-bold tracking-tight md:text-3xl lg:text-4xl">
                Welcome to Expert MERN Stack Development and Web Design
                Services!
              </h2>
              <p className="mt-8 text-lg text-yello-700">
                Transform your ideas into reality with expert MERN stack
              ...
              <div className="mt-4 space-x-2">
                <Link to="/contact">
                  <button
                    type="button"
                    className="rounded-md bg-[#38A649] px-3 py-2.5 text-sm font-semibold text-[#001601] shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                  >
                    Let's Works
                  </button>
                </Link>
                <Link to="/project">
                  <button
                    type="button"
                    className="rounded-md bg-[#23D54D] px-3 py-2.5 text-sm font-semibold text-[#001601] shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                  >
                    View Work
                  </button>
                </Link>
